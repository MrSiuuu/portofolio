...
import { VscArrowRight, VscCloudDownload, VscHistory } from 'react-icons/vsc';
...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Issa Kouyate',", type: 'array-item' },
    { code: "    role: 'Développeur Fullstack & Chef de projet digital',", type: 'array-item' },
    { code: "    bio: 'Alternance ou poste | IA, Web, Automatisation & Outils métiers'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
    ...
    { code: '        <Link href="/projects">Voir mes projets</Link>', type: 'object-method' },
        ...
        <div className={styles.container}>
          ...
          <div className={styles.infoSection}>
            <h1 className={styles.developerName}>
              Issa <span className={styles.accentText}>Kouyate</span>
            </h1>
            ...
            <p className={styles.bio}>
              Passionné par le développement web, l’IA et l’automatisation, je recherche une <strong>alternance</strong> ou un <strong>poste</strong> pour contribuer à des projets concrets et progresser avec une équipe ambitieuse.
            </p>
            ...
            <div className={styles.actionLinks}>
              ...
              <a
                href="/Issa_Kouyate_CV.pdf"
                download
                className={styles.secondaryLink}
              >
                Télécharger CV <VscCloudDownload />
              </a>

              <Link href="/experiences" className={styles.secondaryLink}>
                Expériences <VscHistory />
              </Link>
            </div>
          </div>
        </div>
